...
const RegisterPage = () => {
  ...
  const registerMutation = useMutation({
    ...
    onError: (error) => {
      toast.error(
        "Ocurrio un error al registrarte, intenta nuevamente en unos minutos."
      );
      console.error(error);
    },
  });
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    // SI LAS CONTRASEÑAS NO COINCIDEN, SE MUESTRA EL MENSAJE, DE LO CONTRARIO DETONAMOS LA FUNCION PARA HACER
    // LA MUTACION Y CREAR AL USUARIO
    if (password !== re_password) {
  ...
  // ESTAS DOS COSAS LAS TENEMOS ARRIBA, ISAUTH VIENE DEL STORE O LOCALSTORE
